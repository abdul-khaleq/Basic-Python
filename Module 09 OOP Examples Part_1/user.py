...
ubar = Ride_Sharing('Ubar')
labib = Rider('Labib Hasan', 'labib.hasan@gmail.com', 1200, 'Bogura')
ubar.add_rider(labib)

abdul_khaleq = Driver('Abdul Khaleq', 'abdulkhaleq6008@gmail.com', 5648, 'Sherpur')
ubar.add_driver(abdul_khaleq)
print(ubar)

labib.request_ride(ubar, 'Dhaka')
labib.show_current_ride()
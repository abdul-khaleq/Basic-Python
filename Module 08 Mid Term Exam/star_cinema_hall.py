...
_hall = Hall(4,4,101)
print(_hall._num_ofTicket, 'Hello')
...
while True:
    ...
    if option == '1':
        ...
        noOfTicket = int(input("Number of Ticket: "))
        if noOfTicket > _hall._num_ofTicket:
            print('You can not book more than seats')
        else:
            for _ in range(noOfTicket):
